@for ($i = 1; $i <= $cartQty; $i++)
	<div class="col-md-6">
		...
		<div class="form-group {{ $errors->has('birthdate'. $i) ? ' has-error' : '' }}">
			...
			<input type="text" name="birthdate{{$i}}" class="form-control" data-plugin="formatter" data-pattern="[[99]]/[[99]]/[[9999]]">
		...
		<div class="form-group {{ $errors->has('phone'. $i) ? ' has-error' : '' }}">
			...
			<input type="text" name="phone{{$i}}" class="form-control" data-plugin="formatter" data-pattern="([[999]]) [[999]]-[[9999]]">
